...
def main():
    ...
    # Generate for 1929 and 2026
    out1 = os.path.join(root, 'image1929.png')
    out2 = os.path.join(root, 'image2026.png')

    make_plot_for_year(df, 1929, out1)
    make_plot_for_year(df, 2026, out2)
